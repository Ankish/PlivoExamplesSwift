...
class DialPadViewController: UIViewController {
    ...
    private func setUp() {
        ...
        self.clearButton.image = UIImage(named: "ClearIcon")?.withRenderingMode(.alwaysTemplate)
        self.clearButton.tintColor = AppUtility.plivoColor
        ...
        self.title = NSLocalizedString("Dial Pad", comment: "")
    ...
    @IBAction func callButtonAction(_ sender: Any) {
        ...
        if let number = number {
            reset()
            let callController = CallViewController.storyBoardControllerForOutGoing(callerId: AppUtility.getUserNameWithoutDomain(number),callerName : number,isOutGoing: true)
